...
run_name = f"{cfg.DISPATCHING_RULE}_{mode_str}_{timestamp}"
new_output_dir = os.path.join(cfg.OUTPUT_DIR, run_name)
cfg.OUTPUT_DIR = new_output_dir
print(f"[INFO] Results will be saved to: {cfg.OUTPUT_DIR}")
